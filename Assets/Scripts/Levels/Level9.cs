...
public class Level9 : GridManager {
	...
	void init(){
		...
		GridHeight = 8;
		moves = 15;
		gameoverMessage = "Level Nine Game Over Message";
		cigOn = true;
	...
	protected override IEnumerator CreateGrid (List<Vector2> cigPositions)
	{
		...
		beerPositions.Add (new Vector2(1,3));
		beerPositions.Add (new Vector2(2,3));
		beerPositions.Add (new Vector2(3,3));
		beerPositions.Add (new Vector2(4,3));
		beerPositions.Add (new Vector2(5,3));
		beerPositions.Add (new Vector2(6,3));
